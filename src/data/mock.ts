    ...
    team: [
        {
            ...
            activities: [
                ...
                { id: "act2", label: "Reuniões", scheduled: 5, realized: 7 },
                { id: "act3", label: "Discador", scheduled: 0, realized: 0 },
                { id: "act4", label: "BOT", scheduled: 2, realized: 2 },
                { id: "act5", label: "MKT", scheduled: 0, realized: 0 },
                { id: "act6", label: "Prospecção Ativa", scheduled: 3, realized: 3 },
                { id: "act7", label: "Síndicos Profissionais", scheduled: 2, realized: 2 },
                { id: "act8", label: "Busca Externa", scheduled: 0, realized: 0 },
            ]
        },
        {
            id: "outros",
            name: "Outros condomínios",
            role: "Equipe",
            photoUrl: "https://api.dicebear.com/7.x/shapes/svg?seed=outros",
            ...
            activities: [
                { id: "act1", label: "Contratos Fechados", scheduled: 0, realized: 0 },
                { id: "act2", label: "Reuniões", scheduled: 8, realized: 3 },
                { id: "act3", label: "Discador", scheduled: 2, realized: 0 },
                { id: "act4", label: "BOT", scheduled: 1, realized: 1 },
                { id: "act5", label: "MKT", scheduled: 1, realized: 1 },
                { id: "act6", label: "Prospecção Ativa", scheduled: 3, realized: 1 },
                { id: "act7", label: "Síndicos Profissionais", scheduled: 1, realized: 1 },
                { id: "act8", label: "Busca Externa", scheduled: 0, realized: 0 },
            ]
        },
